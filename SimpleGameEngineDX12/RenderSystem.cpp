...
RenderSystem::RenderSystem()
{
	...
	if (FAILED(res))
	{
		throw std::exception("FAILED TO INITIALIZE RENDER SYSTEM");
	}
...
bool RenderSystem::compileVertexShader(const wchar_t* filename, const char* entrypoint_name, void** shader_byte_code, size_t* byte_code_size)
{
...
bool RenderSystem::compilePixelShader(const wchar_t* filename, const char* entrypoint_name, void** shader_byte_code, size_t* byte_code_size)
{
	ID3DBlob* errblob = nullptr;
